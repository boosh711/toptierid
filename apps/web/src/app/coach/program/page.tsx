  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-6xl px-4 py-8">
        <h1 className="font-display text-2xl text-navy">Program workspace</h1>
        {coach?.program ? (
          <div className="card mt-6">
            <h2 className="font-semibold">{coach.program.name}</h2>
            <p className="text-slate-600">{coach.program.college}</p>
          ...
          <p className="mt-4 text-slate-600">You are not assigned to a program workspace.</p>
        )}
      </main>
    </>
  );
